...
class FundsStructureByType extends StatelessWidget {
    ...
    return Column(
      children: [
        Container(
            ...
            child: Stack(
              children: [
                Obx(() => GaugeChart(c.fundsStructureByType.value)),
                Container(
        ...
        Container(
          child: Obx(() => Wrap(
            ...
            children: c.fundsStructureByType.map((e) {
                return FundsStructureByTypeItem(e.percent, e.diffPercent, e.amount, e.diffAmount, c.getLabelTypeByValue(e.type), color: e.color, type: e.type);
              }).toList()
          )),
        ),
      ],
...
class FundsStructureByTypeItem extends StatelessWidget {
  ...
  FundsStructureByTypeItem(this.percent, this.diffPercent, this.amount, this.diffAmount,
